...
The isolated integration suite passes 49 checks:
...
The Masters catalogue adds 13 passing checks for exact inventory, exclusions, search aliases, authentication and role access. Total: 49 checks.
