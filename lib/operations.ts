...
const masterFields: Record<string, OpField[]> = {
  'company-information': [
    f('name', 'Legal company name', 'text', true, undefined, 'Legal Identity'),
    f('tradeName', 'Trading name', 'text', false, undefined, 'Legal Identity'),
    f('gstin', 'GSTIN', 'text', false, undefined, 'Statutory IDs'),
    f('pan', 'PAN', 'text', false, undefined, 'Statutory IDs'),
    f('iec', 'IEC', 'text', false, undefined, 'Statutory IDs'),
    f('email', 'Email', 'email', false, undefined, 'Contact'),
    f('phone', 'Phone', 'text', false, undefined, 'Contact'),
    f('website', 'Website', 'url', false, undefined, 'Contact'),
    f('address', 'Registered address', 'textarea', false, undefined, 'Addresses'),
    f('country', 'Country', 'text', false, undefined, 'Addresses'),
    f('logoDataUrl', 'Company logo', 'dataurl', false, undefined, 'Branding'),
    f('headerDataUrl', 'Document header image', 'dataurl', false, undefined, 'Branding'),
    f('signatureDataUrl', 'Signature image', 'dataurl', false, undefined, 'Branding'),
    f('authorizedSignatory', 'Authorised signatory name', 'text', false, undefined, 'Document Defaults'),
    f('invoicePrefix', 'Customer invoice prefix', 'text', false, undefined, 'Document Defaults'),
    f('customsPrefix', 'Customs document prefix', 'text', false, undefined, 'Document Defaults'),
    f('footerText', 'Document footer text', 'textarea', false, undefined, 'Document Defaults'),
  ],
  'company-addresses': [
    ...
    fields:
      key === 'products'
        ? [
            ...
            f('productTag', 'Product tag'),
            f('defaultRate', 'Default selling price', 'number', false, undefined, 'Pricing'),
            f('gstRate', 'Default GST percentage', 'number', false, undefined, 'Pricing'),
            f('weight', 'Net weight (kg)', 'number', false, undefined, 'Measurements'),
            f('grossWeight', 'Gross weight including packaging (kg)', 'number', false, undefined, 'Measurements'),
            f('lengthCm', 'Length (cm)', 'number', false, undefined, 'Measurements'),
            f('widthCm', 'Width (cm)', 'number', false, undefined, 'Measurements'),
            f('heightCm', 'Height (cm)', 'number', false, undefined, 'Measurements'),
            f('dimensions', 'Additional dimension notes', 'text', false, undefined, 'Measurements'),
...
for (const [key, label, group, fields] of [
  ...
  [
    ...
    [
      ...
      f('originPort', 'Port of loading'),
      f('destinationPort', 'Port of discharge'),
      f('vessel', 'Vessel'),
      f('voyage', 'Voyage'),
      f('departureDate', 'Actual departure', 'date'),
      f('arrivalDate', 'Actual arrival', 'date'),
      f('deliveredDate', 'Actual delivery', 'date'),
      f('trackingSource', 'Tracking update source'),
      f('trackingUpdatedDate', 'Tracking last checked', 'date'),
    ],
  ],
  [
    'production-orders',
